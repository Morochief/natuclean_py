...
export default function ContactForm() {
  ...
  const contactInfo = [
    { iconType: 'location', label: 'Dirección', value: 'Asunción, Paraguay' },
    { iconType: 'phone', label: 'WhatsApp', value: '+595 981 123 456' },
    { iconType: 'email', label: 'Email', value: 'hola@natuclean.com' },
    { iconType: 'clock', label: 'Horario', value: 'Lun - Sáb: 9:00 - 18:00' },
  ];
          ...
          <div class="contact__details">
            {contactInfo.map((item) => (
              <div class="contact__detail">
                <span class="contact__detail-icon">{icons[item.iconType]()}</span>
